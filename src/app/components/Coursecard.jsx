  ...
  return (
    <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="relative overflow-hidden h-48">
        ...
        <span className="absolute top-3 left-3 bg-white/95 backdrop-blur-sm text-violet-700 text-xs font-bold px-3 py-1 rounded-full shadow-sm">
          {category}
        </span>
        <div className="absolute top-3 right-3 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer hover:bg-white">
      ...
      {/* Body */}
      <div className="p-5">
        <h3 className="font-bold text-gray-900 text-base leading-snug mb-2 group-hover:text-violet-700 transition-colors duration-200 line-clamp-2">
          {title}
        </h3>
        <p className="text-gray-500 text-sm mb-3">by {instructor}</p>
