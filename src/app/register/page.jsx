...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950 to-indigo-950 flex items-center justify-center px-4 py-16">
      {/* Blobs */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 text-white placeholder-gray-500 rounded-2xl px-4 py-3.5 text-sm focus:outline-none focus:border-violet-500 focus:bg-white/10 transition-all duration-200"
              />
              <p className="text-xs text-gray-500 mt-1.5 ml-1">Paste a link to your profile photo (optional)</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1 ml-1">Password strength</p>
            </div>

            <div className="flex items-start gap-3">
              <input type="checkbox" id="terms" className="checkbox checkbox-sm checkbox-primary rounded mt-0.5" />
            ...
            <button className="w-full btn bg-gradient-to-r from-violet-600 to-indigo-600 text-white border-none rounded-2xl font-bold text-base py-4 hover:from-violet-700 hover:to-indigo-700 hover:shadow-xl hover:shadow-violet-900/50 hover:scale-[1.01] transition-all duration-300 mt-2">
              Create Free Account
            </button>
          </div>
          ...
          <button className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3.5 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-[1.01] border border-gray-200">
