      ...
      <section className="py-24 bg-linear-to-br from-violet-600 to-indigo-700 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link href="/courses" className="btn btn-outline border-white/50 text-white hover:bg-white/10 hover:border-white btn-lg rounded-2xl font-bold px-8 transition-all duration-300">
              Browse Courses
            </Link>
          </div>
        </div>
