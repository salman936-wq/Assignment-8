    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950 to-indigo-950 flex items-center justify-center px-4 py-16">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          {/* Google button */}
          <button className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3.5 rounded-2xl mb-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.01] border border-gray-200">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              <input type="checkbox" id="remember" className="checkbox checkbox-sm checkbox-primary rounded" />
              <label htmlFor="remember" className="text-sm text-gray-400 cursor-pointer">Remember me for 30 days</label>
            </div>

            <button className="w-full btn bg-gradient-to-r from-violet-600 to-indigo-600 text-white border-none rounded-2xl font-bold text-base py-4 hover:from-violet-700 hover:to-indigo-700 hover:shadow-xl hover:shadow-violet-900/50 hover:scale-[1.01] transition-all duration-300">
              Sign In
            </button>
          </div>
